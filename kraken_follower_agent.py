...
class KrakenFuturesAPI:
    ...
    async def get_accounts(self) -> Dict:
        ...
        return await self._private_request("/derivatives/api/v4/accounts", method="GET")
    ...
    async def fetch_balance(self) -> Dict:
        ...
        """
        try:
            print("🔍 Calling Kraken API: /derivatives/api/v4/accounts")
            accounts_data = await self._private_request("/derivatives/api/v4/accounts", method="GET")
    ...
    async def send_bracket_order(
        ...
        return await self._private_request(
            "/derivatives/api/v4/batchorder",
            {"json": str(batch_order).replace("'", '"')}
        )
    
    async def get_open_positions(self) -> Dict:
        """Get all open positions"""
        return await self._private_request("/derivatives/api/v4/openpositions", method="GET")
    ...
    async def cancel_all_orders(self, symbol: str = None) -> Dict:
        ...
        if symbol:
            data["symbol"] = symbol
        return await self._private_request("/derivatives/api/v4/cancelallorders", data)
